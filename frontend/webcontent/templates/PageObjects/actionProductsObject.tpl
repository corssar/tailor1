<div class="carouselContainer">
    <div class="carouselContent">
        <div class="cTitle">
            <p>{webtext keyword="carousel_action_title" value="јкционные товары" remark="Home page"}</p>
        </div>
        <div id="isScroll" class="cProducts">
            <ul class="cProductList">
                {foreach item=$product from=$testCount}
                    <li class="cProduct">
                        <a href="#" class="pImg">
                            <div>
                                <img src="http://demoshop.imagecms.net/uploads/shop/products/medium/12787_main_origin.jpg"
                                     class="vImg">

                                <div class="pStatus hit"></div>
                            </div>
                            <span class="pTitle">Samsung GT-I9500 Galaxy S4 ZKA Black</span>
                        </a>

                        <div class="pDescription">
                            <div class="pRating">
                                <div class="pStars">
                                    <div class="pRate star-small">
                                        <div style="width: 100%;"></div>
                                    </div>
                                </div>
                                <a href="#"
                                   class="pCommentCount">3 {webtext keyword="carousel_product_comment" value="отзыва" remark="Home page"}</a>
                            </div>
                            <div class="pPrices">
                                <div class="pPriceDiscount">7000 <b>grn</b></div>
                                <div class="pPriceCurrent">3000 <b>grn</b> <b>(33.3 $)</b></div>
                            </div>
                            <div class="pBuyButton">
                                <button>
                                <span><svg height="15" version="1.1" width="16" xmlns="http://www.w3.org/2000/svg"
                                        ...
                                        <path fill="#ffffff" stroke="none"
                                              ...
                                              transform="matrix(0.5054,0,0,0.5054,-0.1855,-1.5367)"
                                              stroke-width="1.978613333177567"
                                              style="-webkit-tap-highlight-color: rgba(0, 0, 0, 0);"></path>
                                    </svg></span>
                                    <span>{webtext keyword="carousel_product_buy_btn" value=" ”ѕ»“№" remark="Home page"}</span>
                                </button>
                            </div>
                        </div>
                    </li>
...
{literal}
    <script>
        $(document).ready(function(){
            var scrollPane = $('#isScroll').jScrollPane({
                showArrows:true,
                horizontalGutter:30});
