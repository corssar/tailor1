    ...
    <div class="container">
        <div class="right-catalog">
            <div class="f-s_0 title-category">
                ...
                <span class="count">(177 товаров)</span>
            </div>
            <div class="frame-header-category">
                <div class="header-category f-s_0">
                    <div class="inside-padd clearfix">
                        <div class="frame-sort f-s_0 d_i-b">
                            <span class="title">{webtext value="Модель: " keyword="catalog_filer_auto_model"}</span>
                            <div class="lineForm">
                                <select>
                                    <option>1</option>
                                    <option>2</option>
            ...
            {if count($categories) > 0}
                <div id="categoriesList">
                    <div class="sub-categories">
                        <span>{webtext value="Другие подразделы категории: " keyword="other_category_sections"}</span>
                    </div>
                    <ul class="listItems">
