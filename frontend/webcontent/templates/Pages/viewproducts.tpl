                    ...
                    <div class="frame-prices f-s_0">
                        {if {price_format price = $product.oldPrice} != ''}
                            <span class="price-discount">
                                    <span>
                                        <span class="price priceOrigVariant">{$product.oldPrice}&nbsp;<span class="curr">{webtext value="ÃÐÍ." keyword="grn_currency"}</span></span>
                                    </span>
                                </span>
                            <span class="current-prices f-s_0">
                                <span class="price-new">
                                    <span>
                                        <span class="price priceVariant">{$product.price}&nbsp;<span class="curr">{webtext value="ÃÐÍ." keyword="grn_currency"}</span></span>
                                    </span>
                                </span>
                            </span>
                        {else}
                    ...
                    <div class="frame-without-top">
                     ...
                     <div class="btn-buy">
                        <button type="button"
                            ...
                            <span class="text-el">{webtext value="Êóïèòü" keyword="buy-button"}</span>
                        </button>
                     </div>
                </div>
            </li>
