...
//iwan: This is the function that sends the results of the image uploading process.
function SendImageUploadResults($errNumber, $resultData)
{
    echo '<script type="text/javascript">' ;
//    echo 'var imagesArr = '.json_encode($resultData[0]).';';
    echo 'window.parent.OnImageUploadCompleted('.$errNumber.', '.json_encode($resultData).');' ;
    echo '</script>' ;
    exit ;
}
