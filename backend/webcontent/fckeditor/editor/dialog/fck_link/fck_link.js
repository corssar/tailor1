...
if ( FCKConfig.LinkUpload )
	...
	window.parent.AddTab( 'Searchmanager', FCKLang.DlgLnkInsidePage, true ) ;

	
	window.parent.AddTab( 'Filemanager', FCKLang.DlgLnkInsideFile, true ) ;
...

{
	...
	ShowE('divSearchmanager'	, ( tabCode == 'Searchmanager' ) ) ;
	
	
	ShowE('divFilemanager'	, ( tabCode == 'Filemanager' ) ) ;
...
oRegex.UriProtocol = /^(((https|ftp|news):\/\/)|mailto:)/gi ;





oRegex.UrlOnChangeProtocol = /^(https|ftp|news):\/\/(?=.)/gi ;
...

{
	...
	if ( FCKConfig.LinkUpload )
		...
		window.parent.SetTabVisibility( 'Searchmanager'	, (linkType == 'url') ) ;
		
		
		window.parent.SetTabVisibility( 'Filemanager'	, (linkType == 'url') ) ;
