...
DlgLnkInsidePage	: "Внутренняя страница",
DlgLnkInsideFile	: "Внутренний файл",
DlgLnkWarning		: "* Внимание, делая ссылку на внешний ресурс(другой сайт) не забывайте начинать вашу запись с указания протокола &quot;http://&quot;, для указания ссылки на внутренний ресурс(страница, файл), который находится на этом сервере, выберите наобходимый объект в табе &quot;Внутренняя страница&quot; или &quot;Внутренний файл&quot; соответственно и данное поле заполнится автоматически",
